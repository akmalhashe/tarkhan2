...
function wp_bac_breadcrumb($sign) {
    ...
    if (!is_front_page()) {
        ...
        echo '<div class="xo-breadcrumb"><small class="you-here">You are here</small>';
        ...
        echo '<strong class="current-page">';
